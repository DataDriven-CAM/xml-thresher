...
build/src/io/xpath/XPath31ParserBase.o: CXXFLAGS= -DNDEBUG -O3 -fPIC -pthread -std=c++26 -Iinclude -Isrc -I./src/parsing -I./cpp_modules/zlib/dist/include -I./cpp_modules/antlr4/runtime/Cpp/run/include/antlr4-runtime -MMD
...
build/src/parsing/XPath31Lexer.o: CXXFLAGS= -DNDEBUG -O3 -fPIC -pthread -std=c++26 -Iinclude -Isrc -I./src/parsing -I./cpp_modules/zlib/dist/include -I./cpp_modules/antlr4/runtime/Cpp/run/include/antlr4-runtime -MMD
...
build/src/parsing/XPath31Parser.o: CXXFLAGS= -DNDEBUG -O3 -fPIC -pthread -std=c++26 -Iinclude -Isrc -Iinclude/io/xpath -I./src/parsing -I./cpp_modules/zlib/dist/include -I./cpp_modules/antlr4/runtime/Cpp/run/include/antlr4-runtime -MMD
